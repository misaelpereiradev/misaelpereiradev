...
- New banner generated by **Gemini**.
- Azure Pipelines icon to **DevOps** section.
- Azure DevOps link to **Tools** - **Deployment** section.

### Changed

- Word **FullStack** by **Senior** in **About Me** section.
- Websocket icon from **Frontend** to **Backend** section.
- Kafka icon and GRPC icon spots.

### Removed

- Leonardo AI prompt and banner.
- Extra information in **About Me** section.
- CircleCI icon from **DevOps** section.
- CircleCI link from **Tools** - **Deployment** section.
- **Documentation** row from **Tools** table section.
